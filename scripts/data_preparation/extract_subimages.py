...
import sys
sys.path.append('/data2/renyulin/MambaIR-main')
...
def main():
    ...
    # HR images
    opt['input_folder'] = '/data2/renyulin/MambaSR_LW/DF2K+OST'
    opt['save_folder'] = '/data2/renyulin/MambaSR_LW/CSR_dataset/DF2K_HR_sub'
    opt['crop_size'] = 480
    opt['step'] = 240
    opt['thresh_size'] = 0
    ...
    # LRx4 images
    # opt['input_folder'] = '/data2/renyulin/MambaSR_LW/CSR_dataset/JPEG/40'
    # opt['save_folder'] = '/data2/renyulin/MambaSR_LW/CSR_dataset/LR_40_sub'
    # opt['crop_size'] = 120
    # opt['step'] = 60
    # opt['thresh_size'] = 0
    # extract_subimages(opt)
